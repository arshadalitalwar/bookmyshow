...
app.get("/outdoor", async (req, res) => {
  ...
  res.status(200).json({ data: outdoors });
});
...
app.get("/laughter", async (req, res) => {
  ...
  res.status(200).json({ data: laughters });
});
...
app.get("/popular", async (req, res) => {
  ...
  res.status(200).json({ data: populars });
});
...
app.get("/latest", async (req, res) => {
  ...
  res.status(200).json({ data: latests });
});
